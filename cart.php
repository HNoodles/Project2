        ...
        if ($resultCart->num_rows == 0) {// no result
            ...
            <div class="row">
                ...
                <form id="buy" class="invisible" name="buy">
                    <input type="number" id="userID" name="userID" value="<?php echo $user['userID'] ?>">
                    <input type="number" id="balance" name="balance" value="<?php echo $user['balance'] ?>">
                    <input type="number" id="totalPrice" name="totalPrice" value="<?php echo $totalPrice ?>">
                </form>
            </div>
